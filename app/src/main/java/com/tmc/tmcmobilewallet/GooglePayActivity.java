...
public class GooglePayActivity extends AppCompatActivity {
    ...
    private TextView googlepaycointrxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(GooglePayActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        Mprogress = new ProgressDialog(GooglePayActivity.this);
        EarnDatabase = FirebaseDatabase.getInstance().getReference().child("Earn");
        EarnDatabase.keepSynced(true);
        id = findViewById(R.id.GooglepayID);
        coin = findViewById(R.id.Googlepaycoin);
        submitbutton = findViewById(R.id.GooglepayButtonID);
        ...
        googlepaycointrxt = findViewById(R.id.googlepaycount);
        toolbar = findViewById(R.id.GoogleToolvat);
        ...
        MuserCoinDatabase.child(CurrentUserID)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            String x= dataSnapshot.child("value").getValue().toString();
                            googlepaycointrxt.setText(x+".0");
                        }
                    }
        ...
        submitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               final String coinget = coin.getText().toString();
              final   String idget = id.getText().toString();
                ...
                if(coincounter <= 5000){
                    ...
                    if(idget.isEmpty()){
                        id.setError("Googlepay id require");
                    }
                    else if(coinget.isEmpty()){
                        coin.setError("Coin require");
                    }
                    else   if(Integer.parseInt(coinget) <= 4999){
                        ...
                        winmap.put("GooglePay_ID", idget);
                        winmap.put("coinget", coinget);
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            int updatecoin = coincounter - Integer.parseInt(coinget);
