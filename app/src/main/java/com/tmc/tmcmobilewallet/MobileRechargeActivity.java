...
public class MobileRechargeActivity extends AppCompatActivity {
    ...
    private DatabaseReference Mcoindatabase, MwinCoinDatabase, EarnDatabase, MuserCoinDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(MobileRechargeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        totalcointext = findViewById(R.id.MobilerechargecoinID);
        ...
        Mprogress = new ProgressDialog(MobileRechargeActivity.this);
        ...
        id = findViewById(R.id.MobileNumbers);
        coin = findViewById(R.id.MobileCoinID);
        submitbutton = findViewById(R.id.BkasSubmitButtonID);

        toolbar = findViewById(R.id.MobileRechargeToolbarID);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            ...
                            String vl = dataSnapshot.child("value").getValue().toString();
                            totalcointext.setText(vl+".0");
                        }
                    }
        ...
        submitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coincounter <= 5000){
                    ...
                    winmap.put("Mobile_Recharge", idget);
