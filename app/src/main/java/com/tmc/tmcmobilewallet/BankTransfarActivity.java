...
public class BankTransfarActivity extends AppCompatActivity {
    ...
    private TextView banktransfertext;
    ...
    private String current_balanch;

    private DatabaseReference Meandatabase;
    private int ShortMessage, negativeValShort;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bank_transfar);



        Meandatabase = FirebaseDatabase.getInstance().getReference().child("Earn");
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(BankTransfarActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        Mprogress = new ProgressDialog(BankTransfarActivity.this);
        id = findViewById(R.id.bankID);
        coin = findViewById(R.id.BankCoin);
        submitbutton = findViewById(R.id.BanktransferbuttonID);
        ...
        banktransfertext = findViewById(R.id.bankcoins);
        toolbar = findViewById(R.id.BankToolbarID);
        ...
        /// get current earn
        Meandatabase.child(CurrentUserID)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            current_balanch = dataSnapshot.child("value").getValue().toString();
                        }
                    }
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            ...
                            banktransfertext.setText(val+".0");
                        }
                    }
