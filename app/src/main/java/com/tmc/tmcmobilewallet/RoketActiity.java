...
public class RoketActiity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roket_actiity);
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(RoketActiity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        Mprogress = new ProgressDialog(RoketActiity.this);
        id = findViewById(R.id.RoketIDEdittextID);
        coin = findViewById(R.id.RoketCoin);
        submitbutton = findViewById(R.id.RoketBubmitID);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            ...
                            String l = dataSnapshot.child("value").getValue().toString();
                            rokettext.setText(l+".0");
                        }
                    }
