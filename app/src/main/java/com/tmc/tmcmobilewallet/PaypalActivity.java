...
public class PaypalActivity extends AppCompatActivity {
    ...
    private TextView paypalcointexy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(PaypalActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        Mprogress = new ProgressDialog(PaypalActivity.this);
        id = findViewById(R.id.PaypalID);
        coin = findViewById(R.id.Paypalcoin);
        ...
        paypalcointexy = findViewById(R.id.paypalcount);
        toolbar = findViewById(R.id.PaypalToolbarID);
