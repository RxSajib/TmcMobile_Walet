...
public class BkasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bkas);
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(BkasActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        Mprogress = new ProgressDialog(BkasActivity.this);
        Mcoindatabase = FirebaseDatabase.getInstance().getReference().child("Earn");
        Mcoindatabase.keepSynced(true);
        id = findViewById(R.id.BkasIDEdittextID);
        coin = findViewById(R.id.BkasCoinsID);
        ...
        bkascointext = findViewById(R.id.bkascount);
        toolbar = findViewById(R.id.BkasToolharID);
