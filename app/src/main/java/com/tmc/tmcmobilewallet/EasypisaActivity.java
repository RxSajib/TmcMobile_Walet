...
public class EasypisaActivity extends AppCompatActivity {
    ...
    private TextView easypisacomtext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easypisa);
        ...
        if(isconnected){
            ...
            final Dialog dialog = new Dialog(EasypisaActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        Mprogress = new ProgressDialog(EasypisaActivity.this);
        id = findViewById(R.id.EasypisaID);
        coin = findViewById(R.id.easypisacoin);
        submtbutton = findViewById(R.id.EasypisaButton);
        ...
        easypisacomtext = findViewById(R.id.easypisacount);
        toolbar = findViewById(R.id.EasuToolbarID);
        ...
        submtbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
